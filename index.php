 ...
 function replace()
 {
    ...
    <div style="overflow:auto">
        <div class="menu">
            ...
            <a id="graychino" onclick="document.getElementById('title').replace("Black","gray")" ; onclick="document.getElementById('image').src='https://n.nordstrommedia.com/id/sr3/246b6407-c608-4c7c-8030-5f0791bed104.jpeg?h=365&w=240&dpr=2'">Gray Chino</a>
