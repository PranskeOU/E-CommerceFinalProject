...
<body style="font-family:Verdana;color:#aaaaaa;">
 ...
 function replace()
 {
    ...
    <div style="overflow:auto">
        <div class="menu">
            <a id="blacksweatpants" onclick="document.getElementById('image').src='https://cdn.shopify.com/s/files/1/0089/7912/0206/products/LOTFEELPJ541_21_-MO_800x.jpg?v=1638346603' ; document.getElementById('title').replace("Black","gray"); " >Black Sweatpants</a>
