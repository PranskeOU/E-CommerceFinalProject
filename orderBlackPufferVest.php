    ...
    <div style="overflow:auto">
        ...
        <div class="menu">
            <form onsubmit="return redirectMe();" action="" method="post">
                <label><strong>Price: $36</strong></label>
                <br />
                <br />
        ...
        <div class="main">
            <h2 id="title">Black Puffer Vest</h2>
            <img id="image" src="https://m.media-amazon.com/images/I/71Gvo3cts3L._AC_UY1000_.jpg" width="470"
                height="470">
        </div>
    </div>
