      ...
      <tr>
        ...
        <td>
          <button type="button" class="btn btn-light" data-bs-toggle="modal"
            data-bs-target="#editcustinfo<?= $row["CustomerID"] ?>">
            Edit
          </button>
          <div class="modal fade" id="editcustinfo<?= $row["CustomerID"] ?>" data-bs-backdrop="static"
            data-bs-keyboard="false" tabindex="-1" aria-labelledby="editcustinfo<?= $row["CustomerID"] ?>Label"
            aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5" id="editcustinfo<?= $row["CustomerID"] ?>Label">Edit customer information
                  </h1>
                ...
                <div class="modal-body">
                  ...
                  <form method="post" action="">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="editcustinfo<?= $row["CustomerID"] ?>Name"
                        aria-describedby="editcustinfo<?= $row["CustomerID"] ?>Help" name="icust_name"
                        value="<?= $row['CustomerName'] ?>">
                      <label for="editcustinfo<?= $row["CustomerID"] ?>Name" class="form-label">Customer Email</label>
                      <input type="text" class="form-control" id="editcustinfo<?= $row["CustomerID"] ?>Name"
                        aria-describedby="editcustinfo<?= $row["CustomerID"] ?>Help" name="icust_email"
                        value="<?= $row['CustomerEmail'] ?>">
                      <div id="editcustinfo<?= $row["CustomerID"] ?>Help" class="form-text">Enter customer's information.
                      </div>
                    </div>
