    ...
    <div style="overflow:auto">
        ...
        <div class="menu">
            <form onsubmit="return redirectMe();" action="" method="post">
                <label><strong>Price: $35</strong></label>
                <br />
                <br />
        ...
        <div class="main">
            <h2 id="title">Black Puffer Jacket</h2>
            <img id="image"
                src="https://d4zpg1jklewne.cloudfront.net/steak/spree-variant/2019-1572892255122/mens-leather-puffer-jacket-in-black-product.jpg"
