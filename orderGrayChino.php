    ...
    <div style="overflow:auto">
        ...
        <div class="menu">
            <form onsubmit="return redirectMe();" action="" method="post">
                <label><strong>Price: $25</strong></label>
                <br/>
                <br/>
        ...
        <div class="main">
            <h2 id="title">Gray Chino</h2>
            <img id="image"
                src="https://n.nordstrommedia.com/id/sr3/246b6407-c608-4c7c-8030-5f0791bed104.jpeg?h=365&w=240&dpr=2"
